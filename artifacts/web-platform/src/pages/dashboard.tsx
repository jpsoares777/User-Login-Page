    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="shrink-0 flex items-center gap-6 px-4 py-2.5 border-t" style={{ background: "#2563eb" }}>
        <div className="flex items-center gap-2">
          ...
          <span className="text-base font-bold" style={{color:"#86efac"}}>$ {fmt(totalValorProd)}</span>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-base font-bold" style={{color:"#86efac"}}>{emprestimosData.length}</span>
        </div>
