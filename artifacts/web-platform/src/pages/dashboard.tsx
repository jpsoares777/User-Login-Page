          ...
          <>
            ...
            <div style={{ width:210, flexShrink:0, background:"#f1f5f9", display:"flex",
              ...
              {([
                ...
                { icon:<img src="/icon-clientes2.png" alt="" style={{ width:22, height:22, flexShrink:0, objectFit:"contain", filter:"contrast(1.2) saturate(1.3) brightness(1.05)" }} />, label:"Lista Clientes", accent:"#0369a1", onClick: () => setListaClientesOpen(true) },
                { icon: caixaAberto ? "🔒" : "🔓",
