...
function DesempenhoContent() {
  return (
    <div className="flex-1 overflow-auto" style={{ background: "#f0f2f5", padding: 12 }}>

      {/* Row 1: 3 bar charts */}
      <div className="flex" style={{ height: 220, gap: 16, marginBottom: 16 }}>
      ...
      <div className="flex" style={{ height: 220, gap: 16 }}>
