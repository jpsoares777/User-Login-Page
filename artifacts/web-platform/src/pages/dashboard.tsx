            ...
            {(() => {
              const fieldBox = (label: string, value: string, req = true) => (
                <div key={label}>
                  ...
                  <div style={{ height: 19, border: "1px solid #d1d5db", borderRadius: 3, padding: "0 5px", fontSize: 10, color: "#111827", background: "#f3f4f6", display: "flex", alignItems: "center" }}>{value}</div>
                </div>
              );
              return (
                <div style={{ border: "1px solid #e5e7eb", borderRadius: 5, overflow: "hidden", borderLeft: "3px solid #6366f1" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 4, padding: "3px 8px", background: "#f9fafb", borderBottom: "1px solid #e5e7eb" }}>
                    <span style={{ fontSize: 10 }}>👤</span>
                    <span style={{ fontWeight: 800, fontSize: 9, color: "#1e293b", letterSpacing: "0.06em" }}>DADOS DO CLIENTE</span>
                  </div>
                  <div style={{ padding: "5px 8px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4px 8px" }}>
                    {fieldBox("CPF", mr.doc)}
            ...
            {(() => {
              const fieldBox = (label: string, value: string, req = true) => (
                <div key={label}>
                  ...
                  <div style={{ height: 19, border: "1px solid #d1d5db", borderRadius: 3, padding: "0 5px", fontSize: 10, color: "#111827", background: "#f3f4f6", display: "flex", alignItems: "center", overflow: "hidden", whiteSpace: "nowrap" }}>{value}</div>
                </div>
              );
              ...
              return (
                <div style={{ border: "1px solid #e5e7eb", borderRadius: 5, overflow: "hidden", borderLeft: "3px solid #6366f1" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 4, padding: "3px 8px", background: "#f9fafb", borderBottom: "1px solid #e5e7eb" }}>
                    <span style={{ fontSize: 10 }}>📍</span>
                    <span style={{ fontWeight: 800, fontSize: 9, color: "#1e293b", letterSpacing: "0.06em" }}>ENDEREÇO</span>
                  </div>
                  <div style={{ padding: "5px 8px", display: "grid", gridTemplateColumns: "1fr 2fr 0.6fr", gap: "4px 7px" }}>
                    {fieldBox("CEP", "-")}
