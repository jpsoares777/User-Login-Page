          ...
          <>
            ...
            <div style={{ width:210, flexShrink:0, background:"#f1f5f9", display:"flex",
              ...
              {([
                ...
                { icon:<img src="/icon-clientes2.png" alt="" style={{ width:20, height:20, flexShrink:0, objectFit:"contain", imageRendering:"crisp-edges" }} />, label:"Lista Clientes", accent:"#0369a1", onClick: () => setListaClientesOpen(true) },
                { icon: caixaAberto ? "🔒" : "🔓",
