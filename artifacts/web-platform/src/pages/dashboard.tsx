          ...
          <>
            ...
            <div style={{ width:210, flexShrink:0, background:"#f1f5f9", display:"flex",
              ...
              {([
                ...
                { icon:<img src="/icon-relatorio4.png" alt="" style={{ width:20, height:20, flexShrink:0, objectFit:"contain", imageRendering:"crisp-edges" }} />, label:"Relatório Geral", accent:"#1d4ed8", onClick: () => setActiveMain("Consolidados") },
