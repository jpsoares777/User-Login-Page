          ...
          <>
            ...
            <div style={{ width:210, flexShrink:0, background:"#f1f5f9", display:"flex",
              ...
              {([
                ...
                { icon:<img src="/icon-clientes2.png" alt="" style={{ width:18, height:18, flexShrink:0, objectFit:"contain" }} />, label:"Lista Clientes", accent:"#0369a1", onClick: () => setListaClientesOpen(true) },
                { icon: caixaAberto ? "🔒" : "🔓",
