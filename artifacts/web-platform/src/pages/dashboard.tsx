...
import iconFaturas from "@assets/411796_1781285099580.png";
import {
        ...
        <div style={{ position: "fixed", inset: 0, zIndex: 1000 }} onClick={() => setSideMenuOpen(false)}>
          ...
          <div style={{ position: "absolute", top: 52, left: 10, width: 240, background: "#fff", borderRadius: 10, boxShadow: "0 6px 24px rgba(0,0,0,0.16)", overflow: "hidden" }}
            ...
            {[
              ...
              { icon: null,  label: "Faturas",                       color: "#0891b2", img: iconFaturas, imgSize: 24, imgBg: "#e0f2fe", imgFilter: "invert(39%) sepia(90%) saturate(400%) hue-rotate(170deg) brightness(85%)" },
