...
function RelatóriosContent() {
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      {/* ── Page header bar ── */}
      <div className="shrink-0 flex items-center gap-2 px-4 py-2.5" style={{ background: "#3d6e8e" }}>
        <span style={{ fontSize: 13, fontWeight: 700, color: "#e2e8f0", letterSpacing: "0.02em", display: "flex", alignItems: "center", gap: 6 }}>
          <svg viewBox="0 0 24 24" style={{ width: 15, height: 15, fill: "#e2e8f0" }}><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm-7 3c1.93 0 3.5 1.57 3.5 3.5S13.93 13 12 13s-3.5-1.57-3.5-3.5S10.07 6 12 6zm7 13H5l4-4h10v4z"/></svg>
          $ RELATÓRIOS
        </span>
        <div className="flex-1" />
        <span style={{ fontSize: 12, color: "#e2e8f0", fontWeight: 500 }}>DATA DE REFERÊNCIA: 2026-05-25</span>
      </div>
