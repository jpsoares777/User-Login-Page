    ...
    <>
      ...
      <div className="w-64 shrink-0 border-r border-gray-200 bg-white overflow-y-auto" onClick={onCloseDropdown}>
        ...
        <div className="px-3 py-2 flex items-center gap-1.5 text-gray-800 font-bold text-sm cursor-pointer hover:bg-gray-50">
          ...
          Estado{selectedEstado ? <span className="ml-1 font-normal text-blue-600">— {selectedEstado}</span> : null}
        </div>
          ...
          <>
            ...
            <div style={{ width:210, flexShrink:0, background:"#f1f5f9", display:"flex",
              ...
              {([
                ...
                { icon:<img src="/icon-clientes3.png" alt="" style={{ width:20, height:20, flexShrink:0, filter:"invert(30%) sepia(60%) saturate(500%) hue-rotate(180deg) brightness(60%) contrast(1.3)" }} />, label:"Lista Clientes", accent:"#0369a1", onClick: () => setListaClientesOpen(true) },
                { icon: caixaAberto ? "🔒" : "🔓",
